...
from safe_core.common.numerics import ensure_numeric
from safe_core.common.exceptions import InaSAFEError, BoundsError
from safe_core.common.polygon import (inside_polygon,
                                 clip_lines_by_polygons, clip_grid_by_polygons)
from safe_core.storage.vector import Vector, convert_polygons_to_centroids
from safe_core.storage.utilities import geometry_type_to_string

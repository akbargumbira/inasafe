...
from safe_core.engine.interpolation import (
    interpolate_polygon_raster,
    interpolate_raster_vector_points,
    assign_hazard_values_to_exposure_data,
    tag_polygons_by_grid)
from safe_core.storage.core import (
    read_layer,
    write_vector_data,
    write_raster_data)
from safe_core.storage.vector import Vector
from safe_core.storage.utilities import DEFAULT_ATTRIBUTE
from safe_core.common.polygon import (
...
from safe_core.common.interpolation2d import interpolate_raster
from safe_core.common.numerics import (
    normal_cdf,
    log_normal_cdf,
    erf,
    ensure_numeric,
...
from safe_core.common.utilities import (
    ...
    unique_filename,
    format_int)
from safe_core.common.testing import TESTDATA, HAZDATA, EXPDATA, UNITDATA
from safe_core.common.exceptions import InaSAFEError
from safe_core.impact_functions import get_plugins, get_plugin
from safe_core.impact_functions.core import population_rounding
...
# noinspection PyUnresolvedReferences
from safe_core.impact_functions.earthquake.pager_earthquake_fatality_model import (
    PAGFatalityFunction)
# pylint: enable=W0611
    ...
    def test_interpolation_tsunami_maumere(self):
        ...
        for i in range(N):
            ...
            if pointid == 148:
                ...
                # safe_core test is 3.62477202599, while it is 3.62477204455 when

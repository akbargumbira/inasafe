...
from safe_core.common.utilities import verify, ugettext as safe_tr
from safe_core.common.exceptions import ReadLayerError, WriteLayerError
from safe_core.common.exceptions import GetDataError, InaSAFEError
    ...
    def read_from_qgis_native(self, qgis_layer):
        """Read and unpack vector data from qgis layer QgsVectorLayer.
            ...
            A stub is used now:
                ...
                then call safe_core.read_from_file

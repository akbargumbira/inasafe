# coding=utf-8
"""**Tests for safe_core vector layer class**"""
...
from safe_core.common.utilities import temp_dir, unique_filename
from safe_core.storage.utilities import read_keywords
from safe_core.storage.vector import Vector, QGIS_IS_AVAILABLE

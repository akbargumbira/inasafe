...
from safe_core.storage.vector import (
    Vector,
    convert_polygons_to_centroids)
from safe_core.storage.projection import (
...
from safe_core.storage.core import (
    ...
    bboxstring2list,
    check_bbox_string)
from safe_core.storage.utilities_test import same_API
from safe_core.storage.geometry import Polygon
...
from safe_core.common.testing import (
    ...
    FEATURE_COUNTS,
    GEOTRANSFORMS)
from safe_core.common.utilities import ugettext as tr, unique_filename
from safe_core.common.polygon import is_inside_polygon

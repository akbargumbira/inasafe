...
from safe_core.common.exceptions import ReadMetadataError
from safe_core.defaults import get_defaults
from safe_core.storage.iso_19115_template import ISO_METADATA_XML_TEMPLATE
...
def generate_iso_metadata(keywords=None):
    """Make a valid ISO 19115 XML using the values of safe_core.get_defaults
    ...
    safe_core.defaults.get_defaults. Note that get_defaults takes care of using the
...
def write_iso_metadata_file(xml_filename, keywords=None):
    """Make a valid ISO 19115 XML file using the values of safe_core.get_defaults

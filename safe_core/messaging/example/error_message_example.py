...
import traceback
from safe_core.messaging import (
    Message,
    ErrorMessage,
    ImportantText,
    Paragraph)
...
def error_creator5():
    """Raise a safe_core style error and append a full message."""
    try:
        error_creator4()
    except SafeError, e4:
...
if __name__ == '__main__':
    # best practice non safe_core style errors
    # try:
    #    error_creator2()
    # except IOError, e:
    #    # print e

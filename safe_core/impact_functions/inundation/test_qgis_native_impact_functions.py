...
class TestGisNativeImpactFunctions(unittest.TestCase):
    ...
    def _get_impact_function(
        ...
        safe_core.engine.test_engine.test_flood_population_evacuation
        """

...
from safe_core.impact_functions.earthquake.earthquake_building_impact import (
    EarthquakeBuildingImpactFunction)
from safe_core.impact_functions.inundation.flood_OSM_building_impact import (
    FloodBuildingImpactFunction)
from safe_core.impact_functions.generic.categorised_hazard_population import (
